...
asset_urls = [
    re_path(r'^asset/create/?$', views.AssetCreateView.as_view(),
            name="asset-create"),
...
report_urls = [
    ...
    re_path(r'^expense-summary/?$', views.ExpenseReport.as_view(),
            name='expense-summary'),
    re_path(r'^expense-summary-form/?$', views.ExpenseReportFormView.as_view(),
            name='expense-summary-form'),
    re_path(r'^pdf/expense-summary/(?P<start>[\w %]+)/(?P<end>[\w %]+)/?$',
            views.ExpenseReportPDFView.as_view(), name='expense-summary-pdf'),
    re_path(r'^general-ledger/?$', views.GeneralLedger.as_view(),
            name='general-ledger'),
    re_path(r'^general-ledger-form/?$', views.GeneralLedgerFormView.as_view(),
            name='general-ledger-form'),
    re_path(r'^pdf/general-ledger/(?P<start>[\w %]+)/(?P<end>[\w %]+)/?$',
            views.GeneralLedgerPDFView.as_view(), name='general-ledger-pdf'),
    ...
    re_path(r'^journal-form/(?P<pk>[\d]+)/?$',
            views.JournalFormView.as_view(), name='journal-form'),
    re_path(r'^journal-report/?$', views.JournalReport.as_view(),
            name='journal-report'),
