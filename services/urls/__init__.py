...
urlpatterns = [
    ...
    re_path(r'^create-category/?$',
            views.ServiceCategoryCreateView.as_view(), name='create-category'),
    re_path(r'^update-category/(?P<pk>[\d]+)/?$',
            views.ServiceCategoryUpdateView.as_view(), name='update-category'),
    re_path(r'^category-detail/(?P<pk>[\d]+)/?$',
            views.ServiceCategoryDetailView.as_view(), name='category-detail'),
    re_path(r'^category-list/?$',
            views.ServiceCategoryListView.as_view(), name='category-list')
]
