...
report_urls = [
    ...
    path("reports/time-logs-report/",
         services.views.TimeLogReportView.as_view(),
         name="reports-time-logs"),
    path("reports/time-logs-report-pdf/<str:start>/<str:end>/",
         services.views.TimeLogReportPDFView.as_view(),
         name="reports-time-logs-pdf"),
    path("reports/forms/time-logs/",
         services.views.TimeLogReportFormView.as_view(),
         name="reports-time-logs-form"),
