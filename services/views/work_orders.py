...
class WorkOrderRequestListView(ContextMixin, PaginationMixin, FilterView):
    ...
    extra_context = {
        'title': 'Work Orders',
        'description': 'Work Orders are requests generated by the system whenever a service invoice is created. These are fulfilled by jobs that track the execution of a service ',
