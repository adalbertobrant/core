...
crm_urls = [
    ...
    path('crm-async-dashboard/', CRMAsyncDashboard.as_view(), name='crm-async-dashboard'),
    path('create-contact/<int:lead>', CreateContact.as_view(), name='create-contact'),
    ...
    path('list-contacts', ContactListView.as_view(), 
        name='list-contacts'),
    path('create-interaction/<int:pk>', InteractionCreateView.as_view(), name='create-interaction'),
    path('update-interaction/<int:pk>', InteractionUpdateView.as_view(), name='update-interaction'),
    path('list-interactions', InteractionListView.as_view(), name='list-interactions'),
    path('interaction-detail/<int:pk>', InteractionDetailView.as_view(), name='interaction-detail'),
]