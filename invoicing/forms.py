    ...
    def clean(self):
        ...
        if cleaned_data['status'] != 'invoice' and \
            ...
            raise forms.ValidationError(
                'Save the document as invoice if you want to apply a payment')
...
class CustomerStatementReportForm(PeriodReportForm):
    customer = forms.ModelChoiceField(
        models.Customer.objects.all(), widget=Select2Widget)
...
class ImportInvoiceForm(BootstrapMixin, forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML('<h4>Invoice</h4>'),
            Row(
                Column('date', 'due', 'invoice_number',
                       css_class='col-md-6 col-sm-12'),
                Column('customer', 'salesperson', 'sales_tax',
                       css_class='col-md-6 col-sm-12'),
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Row(
                ...
                Column('owner', 'team', 'source',
                       css_class='col-md-6 col-sm-12'),
            ),
            HTML('<h4>Contact</h4>'),
            Row(
                Column('organization', 'contacts',
                       css_class='col-md-6 col-sm-12'),
                Column('opportunity', 'probability_of_sale',
                       css_class='col-md-6 col-sm-12'),
            ),
