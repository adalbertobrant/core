...
urlpatterns = [
    ...
    re_path(r'^unit-create/?$', views.UnitCreateView.as_view(),
            name="unit-create"),
    ...
    re_path(r'^delete-inventory-controller/(?P<pk>[\d]+)/?$',
            views.InventoryControllerDeleteView.as_view(),
            name='delete-inventory-controller'),
]
