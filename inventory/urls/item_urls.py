...
consumable_urls = [
    re_path(r'^consumable-create/?$',
            views.ConsumableCreateView.as_view(), name="consumable-create"),
    re_path(r'^consumable-list/?$', views.ConsumableListView.as_view(),
...
raw_material_urls = [
    re_path(r'^raw-material-create/?$',
            views.RawMaterialCreateView.as_view(), name="raw-material-create"),
    re_path(r'^raw-material-list/?$',
            views.RawMaterialListView.as_view(), name="raw-material-list"),
