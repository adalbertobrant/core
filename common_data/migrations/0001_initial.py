    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_theme', models.IntegerField(choices=[
                 (1, 'Simple'), (2, 'Blue'), (3, 'Steel'), (4, 'Verdant'), (5, 'Warm')], default=1)),
                ...
                ('application_version', models.CharField(
                    blank=True, default='0.0.1', max_length=16)),
                ('currency', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.SET_NULL, to='accounting.Currency')),
            ],
            options={
                'abstract': False,
            },
